...
from models import Base, Personal, Experience, Hobby, Education, Language, Skill, Project, Award, Publication
...
db.add_all([Hobby(name=hobby) for hobby in hobbies])
...
db.add_all([Experience(**exp) for exp in experiences])
...
educations = [
    {
        ...
        "location": "Cluj-Napoca, Romania",
        "period": "2024 – Present",
        "subjects": "Basics of Statistics, Data Ethics, Data Collection and Modeling, Intelligent Modeling, Computational Thinking"
    },
    {
        ...
        "subjects": "Mathematical Analysis, Linear Algebra, Numerical Calculus, Algorithms Design, Optimization, System Identification"
    }
]
db.add_all([Education(**edu) for edu in educations])
...
db.add_all([Language(**lang) for lang in languages])
...
for category, items in skills.items():
    for item in items:
        db.add(Skill(category=category, name=item))

# Projects data
projects = [
    {
        "title": "Data Science Small Projects",
        "description": "Collection of small projects using Jupyter notebooks and ML libraries for data analysis, classification, and visualizations.",
    ...
    },
    {
        ...
        "description": """Personalized Recommendations: Get movie suggestions based on your unique interests.
        ...
        "live_demo": "https://juliab-movie-recommendation-tool.streamlit.app/",
        "period": "2025 – Present"
    }
]
db.add_all([Project(**proj) for proj in projects])

# Awards data
awards = [
    {
        "title": "Vulcanus in Japan Scholarship – EU-Japan Centre",
        "description": "Selected for a prestigious industrial exchange program; trained at Goldman Sachs Japan. Gained professional and cultural experience in Japan.",
        "link": "https://www.eu-japan.eu/events/vulcanus-japan",
        "year": 2021
    }
]
db.add_all([Award(**award) for award in awards])

# Publications data
publications = [
    {
        "title": "A Novel Toolbox for Automatic Design of Fractional Order PI Controllers",
        "description": "Paper based on my Bachelor's thesis. Focuses on SOPDT modeling and FO controller design for automatic tuning.",
        "year": 2023
    }
]
db.add_all([Publication(**pub) for pub in publications])
